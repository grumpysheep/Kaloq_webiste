...
const translations: Record<string, string> = {
  ...
  "Talk to sales": "联系销售",
  "Make your stablecoins spendable. Spend with a card, hold in global accounts, settle at internet speed.": "让您的稳定币随时可用。刷卡消费、全球账户持有、极速结算。",
  Legal: "法律信息",
  "[TODO: Full registered legal entity name], [TODO: registered address]": "[TODO：完整注册法律实体名称]，[TODO：注册地址]",
  "Kaloq is registered as a Money Services Business with FinCEN, registration number [TODO: MSB number].": "Kaloq 已在 FinCEN 注册为货币服务企业，注册编号为 [TODO：MSB 编号]。",
  "Card services are provided through licensed partner institutions. [TODO: issuer/BIN sponsor disclosure line]": "卡片服务由持牌合作机构提供。[TODO：发卡机构/BIN 赞助方披露信息]",
  "Kaloq is not a bank. Stablecoin balances are not FDIC insured.": "Kaloq 并非银行，稳定币余额不受 FDIC 保险保障。",
};
